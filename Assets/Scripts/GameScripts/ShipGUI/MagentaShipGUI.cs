...
//		Debug.Log (shipScreenPos);
        ...
        GUI.Box(new Rect((Screen.width * .35f), (Screen.height * .96f), (Screen.height/18*curHealth), Screen.height/40), "", style);
		style.normal.background = texture2;
		GUI.Box (new Rect((Screen.width * .35f), (Screen.height * .92f), (Screen.height/4*curCool), Screen.height/40), "", style);
